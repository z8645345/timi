...
public class Constant {
	 ...
	 * 演出id不能为空
	 */
	public static final String SHOW_ID_NOT_NULL = "演出id不能为空";
	 ...
	 * 验证码不能为空
	 */
	public static final String CHECKCODE_NOT_NULL = "验证码不能为空";

	/**
	 * 验证码有误
	 */
	public static final String CHECKCODE_ERROR = "验证码有误";
	 ...
	 * 昵称已经被使用
	 */
	public static final String NICKNAME_EXIST = "昵称已经被使用";
